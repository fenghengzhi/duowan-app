...
export default class Zuixinjiongtu extends React.Component<NavigationInjectedProps, State> {
    ...
    async getData() {
        ...
        try {
            // const res = await axios.get('http://tu.duowan.com/tu');
            const res = await axios.get(`http://tu.duowan.com/tu?offset=0&order=created&math=1`);
